...
export patchtls=/NiLphreakz-vmesswstls
export patchnontls=/NiLphreakz-vmesswsntls
...
export patchtls=/NiLphreakz-vlesswstls
export patchnontls=/NiLphreakz-vlesswsntls
export uuid=$(cat /proc/sys/kernel/random/uuid)
