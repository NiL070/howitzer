...
# ================================
wget -q -O /usr/local/bin/ws-https https://raw.githubusercontent.com/${GitUser}/howitzer/main/${namafolder}/ws-https
chmod +x /usr/local/bin/ws-https

wget -q -O /usr/local/bin/ws-http https://raw.githubusercontent.com/${GitUser}/howitzer/main/${namafolder}/ws-http
chmod +x /usr/local/bin/ws-http

wget -q -O /usr/local/bin/ws-ovpn https://raw.githubusercontent.com/${GitUser}/howitzer/main/${namafolder}/ws-ovpn
