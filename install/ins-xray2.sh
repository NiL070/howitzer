...
mkdir /root/.acme.sh
curl https://raw.githubusercontent.com/NiL070/howitzer/main/acme.sh -o /root/.acme.sh/acme.sh
...
wget -O certv2ray "https://raw.githubusercontent.com/${GitUser}/howitzer/main/cert.sh"
wget -O trojaan "https://raw.githubusercontent.com/${GitUser}/howitzer/main/menu/trojaan.sh"
wget -O xraay "https://raw.githubusercontent.com/${GitUser}/howitzer/main/menu/xraay2.sh"
chmod +x port-xray
chmod +x certv2ray
chmod +x trojaan
chmod +x xraay
